...
<main class="main" id="main">
    ...
    @endif
    <div class="container">
        <div class="main-blockTitle" id="main-blockTitle">
            <h1 class="main-title">Онлайн детский сад</h1>
        </div>
        <p class="main-subtitle">по авторской методике Юлии Чучуло</p>
        ...
        <!-- /.main-list -->
        <button class="main-btn section-btn">Получите доступ на месяц <span></span></button>
    </div>
    <!-- /.container -->
</main>
<!-- /.main -->
...
<section class="plan" id="plan">
    <h2 class="plan-title section-title">Программа развития нужных психологических функций и моторных навыков для деток 2+</h2>
    <div class="container">
        <div class="plan-item plan-item_1"><img src="{{ asset('img/plan/img-1.png') }}" alt="" class="plan-item__img"><span><strong>36 занятий в месяц.</strong></span><img src="{{ asset('img/plan/line.svg') }}" alt="" class="plan-line"></div>
        <!-- /.plan-item plan-item_1 -->
        <div class="plan-item plan-item_2"><img src="{{ asset('img/plan/img-2.png') }}" alt="" class="plan-item__img"><span><strong>Занятия от 15 минут в день.</strong></span></div>
    ...
    <!-- /.container -->
    <button class="plan-btn section-btn">Получите доступ на месяц <span></span></button>
</section>
<!-- /.plan -->
...
<section class="offer" id="offer">
    ...
    <div class="container">
        <div class="offer-access">
            ...
            <p class="offer-access__text">Успейте приобрести программу “Умный Ёжик” по самой выгодной цене</p>
        ...
        <div class="offer-features">
            ...
            <div class="offer-item">
                <img src="{{ asset('img/offer/icon-lesson.svg') }}" alt="">12 сопроводительных занятий для мамы
            </div>
            <div class="offer-item">
            ...
            <div class="offer-item">
                <img src="{{ asset('img/offer/icon-global.svg') }}" alt="">Живые эфиры, со встречей новых друзей и полезной информацией
            </div>
        </div>
    </div>
    <!-- /.container -->
